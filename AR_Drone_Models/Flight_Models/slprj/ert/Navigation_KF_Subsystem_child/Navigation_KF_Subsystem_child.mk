###########################################################################
## Makefile generated for Simulink model 'Navigation_KF_Subsystem_child'. 
## 
## Makefile     : Navigation_KF_Subsystem_child.mk
## Generated on : Tue Nov 17 10:17:51 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: ./Navigation_KF_Subsystem_child_rtwlib.lib
...
PRODUCT_NAME              = Navigation_KF_Subsystem_child
MAKEFILE                  = Navigation_KF_Subsystem_child.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Navigation_KF_Subsystem_child_ref.rsp
...
MODELLIB                  = Navigation_KF_Subsystem_child_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = ./Navigation_KF_Subsystem_child_rtwlib.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR)/slprj/ert/Navigation_KF_Subsystem_child -I$(START_DIR) -IC:/Simulink_AR_Drone/AR_Drone_Target/blocks -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -IC:/Simulink_AR_Drone/AR_Drone_Target/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=Navigation_KF_Subsystem_child -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=Navigation_KF_Subsystem_child -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/ert/Navigation_KF_Subsystem_child/Navigation_KF_Subsystem_child.c
...
OBJS = Navigation_KF_Subsystem_child.o
...
%.o : $(START_DIR)/slprj/ert/Navigation_KF_Subsystem_child/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/Navigation_KF_Subsystem_child/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/Navigation_KF_Subsystem_child/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
